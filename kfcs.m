...
%         %% Addition step
%         % Check if Smax reached!
% 
% 
%         % a. Run CS (Dantzig Selector)
%         delta = lambda_m*noisevar_obs;
%         eps = 0.1;%TODO : see what this value means - tolerance for alternating direction method
%         maxiter = 1e5; %TODO : check reasonable estimate for this
%         [betacap,iter,dval,time] = selector(A(:,Tc),' ',filt_error,delta,eps,maxiter);
% 
%         % Threshold to estimate increase in support
%         nz = Tc(betacap.^2 > alpha_a);%careful here
%         Deltacap = Tc(nz);
% 
%         % b. compute T_new,..update support T
%         Tnew = union(T,Deltacap);
%         % c. .. expand P_prior for additional supports
%         % Rerun KF update (5)
% 
% 
%     end
